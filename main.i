...
# 29 "/opt/devkitpro/devkitARM/arm-none-eabi/include/time.h" 3
...
# 1 "goldcoins.h" 1
# 21 "goldcoins.h"
extern const unsigned short goldcoinsBitmap[256];
...
void goToStart() {
    ...
    waitForVBlank();
    drawString4(80, 72, "Raining Gold", 0xFFFF);
    drawString4(70, 100, "Press Start to Play", 0xFFFF);


    char scoreBuffer[20];

    drawString4(80, 120, scoreBuffer, 0xFFFF);
    flipPages();
...
void goToPlay() {
    DMANow(3, startscreenPal, ((unsigned short*) 0x05000000), 256);
    fillScreen4(0xFFFF);
    drawString4(220, 1, scoreBuffer, 0xFFFF);
    waitForVBlank();
    flipPages();
...
void play() {
    ...
    drawString4(180, 1, "Score:", 0xFFFF);
    sprintf(scoreBuffer, "%d", score);
    drawString4(220, 1, scoreBuffer, 0xFFFF);
...
void goToPause() {
    DMANow(3, startscreenPal, ((unsigned short*) 0x05000000), 256);
    fillScreen4(0xFFFF);
    drawString4(80, 100, "Paused", 0x001F);
    drawString4(60, 120, "Press Select to Resume", 0x001F);
    drawString4(60, 130, "Press Start for Scoreboard", 0x001F);
    waitForVBlank();
    flipPages();
    state = PAUSE;
}
...
void goToWin() {
    ...
    drawString4(40, 100, "Congrats, you collected 100 gold!", 0x001F);
    drawString4(80, 120, "Press Start to Play Again", 0x001F);
    playAnalogSound(16);
    waitForVBlank();
    flipPages();
...
void goToScoreboard() {
    ...
    fillScreen4(0xFFFF);
    drawString4(80, 50, "Top Scores", 0x001F);


    char buffer[32];
    sprintf(buffer, "Top Score: %d", topScore);
    drawString4(80, 80, buffer, 0x001F);

    drawString4(80, 120, "Press Start to Return", 0x001F);
    waitForVBlank();
    flipPages();
